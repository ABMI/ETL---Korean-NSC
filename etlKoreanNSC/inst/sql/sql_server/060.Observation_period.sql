...
into @NHISNSC_database.obsv_prd_temp1
...
into @NHISNSC_database.obsv_prd_temp2
from @NHISNSC_database.obsv_prd_temp1
...
select 
	...
	into @NHISNSC_database.obsv_prd_temp3
	from @NHISNSC_database.obsv_prd_temp2 a
		left join
		@NHISNSC_database.obsv_prd_temp2 b
...
select
   ...
   END AS sumday
   into @NHISNSC_database.obsv_prd_temp4
   from @NHISNSC_database.obsv_prd_temp3 a
   order by person_id, id
...
from @NHISNSC_database.obsv_prd_temp4
group by person_id, sumday
order by person_id, observation_period_start_date

drop table @NHISNSC_database.obsv_prd_temp1, @NHISNSC_database.obsv_prd_temp2, @NHISNSC_database.obsv_prd_temp3, @NHISNSC_database.obsv_prd_temp4
